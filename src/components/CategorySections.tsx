...
export function CategorySections() {
  ...
  const setActiveTab = (categorySlug: string, tab: TabType) => {
    setActiveTabs(prev => ({
      ...prev,
      [categorySlug]: tab
    }));
  ...
  const getFilteredArticles = (category: CategoryData, activeTab: TabType) => {
    ...
    if (activeTab === 'hype') {
      // Hype: Editor's choice - manually curated (for now, select first article as main and first side article)
      return {
  ...
  const categories: CategoryData[] = [
    ...
    },
    {
      ...
      mainArticle: {
        id: 5,
        title: 'Nike x Jacquemus: The Sock Collaboration Everyone\'s Talking About',
        excerpt: 'The unexpected partnership between the sportswear giant and French luxury house delivers a collection that perfectly balances performance and high fashion aesthetic.',
        category: 'Drops',
      ...
      sideArticles: [
        {
          id: 6,
          title: 'Palace x Stone Island: Limited Edition Analysis',
          category: 'Drops',
        ...
        {
          id: 7,
          title: 'Supreme SS25: Sock Collection First Look',
          category: 'Drops',
          image: 'https://images.unsplash.com/photo-1580973757787-e22cdecb9cd5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkZXNpZ25lciUyMHNvY2tzJTIwY29sb3JmdWx8ZW58MXx8fHwxNzU2OTgwMTY3fDA&ixlib=rb-4.1.0&q=80&w=1080',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-16">
          {categories.map((category, categoryIndex) => {
            const activeTab = activeTabs[category.slug];
            ...
            <section key={category.slug}>
              ...
              <div className="mb-8 flex items-center justify-between">
                ...
                <div className="flex items-center" style={{ marginLeft: '28px' }}>
                  <button
                    onClick={() => setActiveTab(category.slug, 'hype')}
                  ...
                  <button
                    onClick={() => setActiveTab(category.slug, 'latest')}
